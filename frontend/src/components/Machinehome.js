...
onDelect = (id) =>{
    ...
    axios.delete(`http://localhost:8000/MachineRepair/post/delect/${id}`).then (() =>{
        ...
        <div className="container">
          ...
          <tbody>
            {this.state.MachineRepair.map((MachineRepair,index) =>(
              ...
              <a href="/add" style={{textDecoration:'none',color:'white'}}>&nbsp;Add New Machine</a>
              </button> &nbsp;
              <button className="btn btn-success">
              <a href="/mh" style={{textDecoration:'none',color:'white'}}>&nbsp;Back To Home</a>
              </button> 
